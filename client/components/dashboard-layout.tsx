            ...
            <div>
              ...
              <div className="space-y-1">
                <Link
                  to="/login"
                  className={cn(
                    "flex items-center gap-2 rounded-md ml-4 h-6 px-3 py-2 text-sm transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground border-l-2 border-sidebar-border border-blue-900",
        ...
        <header className="sticky top-0 z-30 flex h-12 items-center gap-4 border-b bg-card px-4 lg:px-6 overflow-x-auto">
          ...
          <div className="ml-auto  flex items-center ">
            ...
            <div className="relative hidden  sm:block">
              ...
              <Input
                placeholder="Search"
                className="w-10 h-6 sm:w-48 lg:w-35 pl-10"
              />
            </div>
