...
export default function CreateQuotation() {
  ...
  const [quotation, setQuotation] = useState<QuotationForm>({
    ...
    total: 0,
    notes: "",
    terms: "Payment is due within 30 days of quotation date. This quotation is valid for 30 days from the date of issue."
  })
  ...
  const handleSave = async (status: "Draft" | "Sent" = "Draft") => {
    ...
    if (quotation.items.some(item => !item.description.trim())) {
    ...
    try {
      ...
      const quotationItems = quotation.items.map(item => ({
        product_id: null, // For now, we don't link to specific products
      ...
      if (data.success) {
        ...
        alert(data.message || `Failed to ${status === 'Draft' ? 'save draft' : 'send quotation'}`)
      }
    } catch (error) {
  ...
  const selectCustomer = (customer: Customer) => {
    ...
    setQuotation(prev => ({
      ...
      customerPhone: '', // We don't have phone in customer data yet
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Add Quotation</h1>
                  ...
                  {selectedCustomer ? (
                    <div className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <Button variant="outline" size="sm" onClick={() => {
                        ...
                        setQuotation(prev => ({ ...prev, customer: '', customerEmail: '', customerAddress: '' }))
                      }}>
                        Change
                      </Button>
                    </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setQuotation(prev => ({ ...prev, quotationDate: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-20">
                      <Input
                        ...
                        max="100"
                        step="0.1"
                        value={quotation.discountRate}
                        onChange={(e) => setQuotation(prev => ({ ...prev, discountRate: parseFloat(e.target.value) || 0 }))}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-20">
                      <Input
                        ...
                        onChange={(e) => setQuotation(prev => ({ ...prev, taxRate: parseFloat(e.target.value) || 0 }))}
                      />
                    </div>
                  </div>
                  <div className="flex justify-between text-sm">
