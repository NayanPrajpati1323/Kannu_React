...
export default function InvoiceDetails() {
  ...
  const [emailSubject, setEmailSubject] = useState(`Invoice ${invoice.number} from Kanakku`)
  const [emailMessage, setEmailMessage] = useState(`Dear ${invoice.customer.name},\n\nPlease find attached your invoice ${invoice.number}.\n\nThank you for your business!`)
  ...
  const handleSendEmail = () => {
    ...
    alert(`Invoice ${invoice.number} has been sent to ${invoice.customer.email}`)
  }
  ...
  const handleRecordPayment = () => {
    ...
    if (amount > 0) {
      setInvoice(prev => ({
        ...
        paidAt: prev.balanceAmount - amount <= 0 ? new Date().toISOString() : prev.paidAt
      }))
      setPaymentAmount("")
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Invoice Details</h1>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-lg font-semibold">${invoice.paidAmount.toFixed(2)}</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-lg font-semibold">${invoice.balanceAmount.toFixed(2)}</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <div className="space-y-1 text-sm">
                  <div className="font-medium">Kanakku</div>
                  ...
                  <div className="text-muted-foreground">contact@kanakku.com</div>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="text-muted-foreground">{invoice.customer.address}</div>
                  <div className="text-muted-foreground">
                    {invoice.customer.city}, {invoice.customer.state} {invoice.customer.zipCode}
                  </div>
                  <div className="text-muted-foreground">{invoice.customer.country}</div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <div className="text-sm mt-1">{new Date(invoice.issueDate).toLocaleDateString()}</div>
              </div>
              <div>
                <Label className="text-sm font-medium">Due Date</Label>
                <div className="text-sm mt-1">{new Date(invoice.dueDate).toLocaleDateString()}</div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="font-semibold">${invoice.balanceAmount.toFixed(2)}</div>
              </div>
            </div>
            <div className="space-y-2">
