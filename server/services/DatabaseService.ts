...
export class DatabaseService {
  ...
  //registeration and login operations
...
static async createCategory(
  ...
  try {
    const [result] = await pool.execute<ResultSetHeader>(
      ...
      [category.name, category.description, category.status || "Active"], // include status
    );
...
static async updateCategory(
  ...
  try {
    const [result] = await pool.execute<ResultSetHeader>(
      ...
      [category.name, category.description, category.status || "Active", id], // include status
    );
